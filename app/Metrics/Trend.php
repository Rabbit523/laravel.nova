...
abstract class Trend extends RangedMetric
{
     ...
     * @return \App\Metrics\TrendResult
     */
    ...
    public function count($request, $model, $unit, $column = null)
    {
        ...
        $keyName = $resource->getQualifiedKeyName();
     ...
     * @return \App\Metrics\TrendResult
     */
    public function averageByMonths($request, $model, $column, $dateCol = null)
    {
        return $this->aggregate($request, $model, self::BY_MONTHS, 'avg', $column, $dateCol);
    }
     ...
     * @return \App\Metrics\TrendResult
     */
    public function averageByMinutes($request, $model, $column, $dateCol = null)
    {
        return $this->aggregate($request, $model, self::BY_MINUTES, 'avg', $column, $dateCol);
    }
     ...
     * @return \App\Metrics\TrendResult
     */
    public function sumByMonths($request, $model, $column, $dateCol = null)
    {
        return $this->aggregate($request, $model, self::BY_MONTHS, 'sum', $column, $dateCol);
    }
     ...
     * @return \App\Metrics\TrendResult
     */
    public function sumByMinutes($request, $model, $column, $dateCol = null)
    {
        return $this->aggregate($request, $model, self::BY_MINUTES, 'sum', $column, $dateCol);
    }
     ...
     * @return TrendResult
     */
    public function maxByMonths($request, $model, $column, $dateCol = null)
    {
        return $this->aggregate($request, $model, self::BY_MONTHS, 'max', $column, $dateCol);
    }
     ...
     * @return \App\Metrics\TrendResult
     */
    public function maxByMinutes($request, $model, $column, $dateCol = null)
    {
        return $this->aggregate($request, $model, self::BY_MINUTES, 'max', $column, $dateCol);
    }
     ...
     * @return \App\Metrics\TrendResult
     */
    public function minByMonths($request, $model, $column, $dateCol = null)
    {
        return $this->aggregate($request, $model, self::BY_MONTHS, 'min', $column, $dateCol);
    }
     ...
     * @return \App\Metrics\TrendResult
     */
    public function minByMinutes($request, $model, $column, $dateCol = null)
    {
        return $this->aggregate($request, $model, self::BY_MINUTES, 'min', $column, $dateCol);
    }
    ...
    protected function formatAggregateResultDate($result, $unit, $twelveHourTime)
    {
        switch ($unit) {
            ...
            case 'hour':
                return with(Chronos::createFromFormat('Y-m-d H:00', $result), function (
                    $date
                ) use ($twelveHourTime) {
            ...
            case 'minute':
                return with(Chronos::createFromFormat('Y-m-d H:i:00', $result), function (
                    $date
                ) use ($twelveHourTime) {
                    return $twelveHourTime
                        ? __($date->format('F')) .
    ...
    protected function getAllPossibleDateResults(
        ...
        $possibleDateResults[
            $this->formatPossibleAggregateResultDate($nextDate, $unit, $twelveHourTime)
        ] = 0;
