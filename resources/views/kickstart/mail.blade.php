<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    /*# sourceMappingURL=minty.css.map */
...
<!--							If you cannot read this email, please  <a class="hlite" href="#" style="text-decoration: none; color: '#004cad'">click here</a>-->
						</td>
					</tr>
					<!-- Spacing -->
					<tr>
							...
							<table width="280" cellpadding="0" cellspacing="0" border="0" align="left" class="devicewidth">
								...
								<tr>
									<td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
										<div class="imgpop">
											<a href="#"><img src="https://app.kinchaku.com/kinchaku-logo.png" alt="logo" border="0" style="display:block; border:none; outline:none; text-decoration:none;" st-image="edit" class="logo"></a>
										</div>
									</td>
								</tr>
								</tbody>
                                ...
                                <td>
                                    <table width="540" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidthinner">
                                        <tbody>
                                            <tr>
                                                <td class="paragraph">
                                                    <p style="text-align:center">会員カードをApple Walletに追加するために、ボタンをクリック、またはQRコードをスキャンしてください。</p>
                                                    <p style="text-align:center;">
                                                        <a style="display:block!important;margin:15px 0;" href="https://r.pass.is/d9ccRiYE9TSr"><img src="https://app.kinchaku.com/Add_to_Apple_Wallet_rgb_JP.svg" style="margin:0 auto;" width="120" height="40" alt="Add to Wallet" /></a>
                                                        <img id="qr" style="margin:15px auto;" width="120" height="120" src="https://d1ye292yvr7tf6.cloudfront.net/images/barcode.php?m=https://r.pass.is/d9ccRiYE9TSr&amp;x2=1&amp;f=qr" alt="Scan this QR code to create a pass" />
                                                    </p>
                                                </td>
                                            </tr>
                                        </tbody>
